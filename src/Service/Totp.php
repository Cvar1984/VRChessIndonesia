 ...
 * in a third-party dependency for a ~20-line algorithm. Verified this
 * session against the official RFC 6238 test vectors — kept hand-rolled
 * rather than swapped for a library since it's already correct.
 */
class Totp
{
